...
return(
    <div className=" h-screen flex flex-col justify-center items-center p-5">
        ...
        {/* content */}
        <div className="bg-gray-400 rounded-2xl w-60 h-72 p-5">
        ...
        <h1 className="text-2xl font-[800]">All your favorites</h1>
        <p className="text-gray-600 pt-4 text-center ">Get all your loved foods in one once place,
